...
const SuperAdminCreateVoucher = () => {
  ...
  const handleCreateVoucher = async (e) => {
    ...
    try {
      ...
      // API request to create and assign the voucher
      const response = await axios.post(
        `http://localhost:8081/super/voucher/${id}`, 
        { amount },
        {
      ...
      setMessage('Voucher created and assigned successfully');
    } catch (error) {
        ...
        <main className="flex-1 mt-0">
          <div className="mt-[40px] sm:ml-[300px] sm:mr-[64px] mx-3">
            <div className="flex justify-between mb-8 gap-8">
              <h1 className="text-xl sm:text-2xl font-bold text-black">Create Voucher</h1>
            ...
            <div className="flex flex-row flex-wrap gap-x-8 gap-y-6 sm:gap-y-12 w-full mb-16 sm:mb-0">
              <div className="bg-white p-8 rounded-lg shadow-md w-full sm:w-[600px]">
                <h2 className="text-lg font-bold mb-4">Assign a Voucher to Credit Agent</h2>
...
export default SuperAdminCreateVoucher;

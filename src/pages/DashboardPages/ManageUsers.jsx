...
import UserTable from '../../comppnents/Dashboard/UserTable'; // Import the UserTable component
  ...
  return (
    <div className="h-screen w-screen overflow-auto m-0 p-0 flex flex-col box-border">
      ...
      <div className="flex-1 flex flex-row mt-0">
        <Aside onManageAgentsClick={() => setActiveTable("users")} />
        <main className="flex-1 mt-0">
          <div className='mt-[40px] sm:ml-[40px] sm:mr-[64px] mx-3'>
            <div className='flex mb-8 gap-8'>
              {/* <h1 className='text-xl sm:text-2xl font-bold text-black'> User's Dashboard</h1> */}
            ...
            <div className="flex flex-row flex-wrap gap-x-8 gap-y-6 sm:gap-y-12 w-full mb-16 sm:mb-0">
             <UserTable users={dashboardState.users.data} />
            </div>
          </div>
        </main>
      </div>
